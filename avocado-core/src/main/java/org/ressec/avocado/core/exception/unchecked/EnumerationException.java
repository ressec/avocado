...
/**
 * Unchecked exception thrown to indicate an error occurred with an enumeration.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class EnumerationException extends org.ressec.avocado.core.exception.unchecked.AbstractUncheckedException
{
    /**
    ...
    /**
     * Thrown to indicate that an error occurred with an enumeration.
     *
