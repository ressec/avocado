...
/**
 * Checked exception thrown to indicate an error occurred while trying to expand a string.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class StringExpanderException extends AbstractCheckedException
{
    /**
    ...
    /**
     * Thrown to indicate that an error occurred while trying to expand a string.
