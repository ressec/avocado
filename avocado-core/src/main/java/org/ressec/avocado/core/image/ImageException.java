...
/**
 * Checked exception thrown to indicate an error occurred with an image.
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse</a>
 * @version 1.0.0
 */
public class ImageException extends AbstractCheckedException
{
    /**
    ...
    /**
     * Thrown to indicate that an error occurred with an image.
     *
